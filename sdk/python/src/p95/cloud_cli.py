...
def create_parser() -> argparse.ArgumentParser:
    ...
    runs_list_parser.add_argument("--project", "-p", required=True,
                                   help="Project in format 'team/app'")
    ...
    runs_metrics_parser.add_argument("metric_name", nargs="?", help="Specific metric name")
    runs_metrics_parser.add_argument("--since-step", type=int, help="Get metrics since step")
    ...
    runs_intervene_parser.add_argument("--action", "-a", required=True,
    ...
    runs_intervene_parser.add_argument("--rationale", "-r", required=True,
                                        help="Explanation for the intervention")
    ...
    # runs interventions
    runs_interventions_parser = runs_sub.add_parser("interventions", help="List interventions")
    ...
    jobs_create_parser.add_argument("--project", "-p", required=True,
                                     help="Project in format 'team/app'")
    ...
    jobs_create_parser.add_argument("--type", "-t", default="training",
                                     choices=["training", "sweep_trial", "evaluation", "custom"])
    jobs_create_parser.add_argument("--rationale", "-r",
                                     help="AI rationale for creating this job")
    ...
    jobs_list_parser.add_argument("--project", "-p", required=True,
                                   help="Project in format 'team/app'")
    ...
    workers_list_parser.add_argument("--project", "-p", required=True,
                                      help="Project in format 'team/app'")
    ...
    worker_start_parser.add_argument("--project", "-p", required=True,
                                      help="Project in format 'team/app'")
